...
public class TcpClient
{
    ...
    {  
        ...
        try
        {
            System.out.println("Client message: Attemping to connect to host " + serverHostname + " on port " + port);
        ...
        {
            System.out.println("Client message: Unabe to connect to host: " + serverHostname + " on port " + port);
        }
